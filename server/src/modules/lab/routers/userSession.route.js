...
import { postUserSessionRequest , getAllUserSessions,postExitTimeRequest, getAllUsersInLab, numberOfUsersInLab, getAllUserSessionsByDate, isUserInLab, getUserSessionsById} from "../controllers/userSession.controller.js";
const router = express.Router();
  ...
  router
  .route("/userhistory")
  .get(requiredAuthMiddleware,getUserSessionsById);
